...
\begin{pitemize}
    ...
    \item[-]Migrated to on-grid DB loader from serial loader pipeline
    ...
    \end{pitemize}
    \item[-]Created developer tools based on library stack, including
    \begin{pitemize}
...
\vspace{0.1in}
\textbf{Languages} \\
Primary: Python, Java, Pig, Bash, Perl, Shell
Secondary: Javascript, HTML5, PHP, C/C++, Ruby, Clojure, Mathematica, CUDA

\vspace{0.1in}

\textbf{Technologies/Skills} \\
Linux, Vim, Hadoop, Oozie, jQuery, Ember.js, Flask, Spring, Jenkins, Agile, Bison/Flex, Antlr, GNU Make
